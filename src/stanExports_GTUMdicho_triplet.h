...
namespace model_GTUMdicho_triplet_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_GTUMdicho_triplet");
    reader.add_event(122, 120, "end", "model_GTUMdicho_triplet");
    return reader;
}
...
GFCU(const int& y,
    ...
    try {
        ...
        stan::model::assign(prob_obs, 
                    ...
                    (1 - inv_logit((((t1 - t2) + blockrandomness) - get_base1(tau, 1, "tau", 1)))), 
...
class model_GTUMdicho_triplet
  : public stan::model::model_base_crtp<model_GTUMdicho_triplet> {
private:
        int Categ;
        int Items;
        int Subjt;
        ...
        double vt;
public:
    model_GTUMdicho_triplet(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_GTUMdicho_triplet_namespace::model_GTUMdicho_triplet";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_GTUMdicho_triplet_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_GTUMdicho_triplet";
    }
...
typedef model_GTUMdicho_triplet_namespace::model_GTUMdicho_triplet stan_model;
#ifndef USING_R
