...
namespace model_GTUMdicho_pair_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_GTUMdicho_pair");
    reader.add_event(91, 89, "end", "model_GTUMdicho_pair");
    return reader;
}
...
GUFC(const int& y,
    ...
    try {
        ...
        validate_non_negative_index("prob_obs", "2", 2);
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> prob_obs(2);
        stan::math::initialize(prob_obs, DUMMY_VAR__);
        stan::math::fill(prob_obs, DUMMY_VAR__);
        ...
        stan::model::assign(prob_obs, 
                    stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                    (1 - inv_logit(((t1 - t2) - get_base1(tau, 1, "tau", 1)))), 
                    "assigning variable prob_obs");
        current_statement_begin__ = 17;
        stan::model::assign(prob_obs, 
                    stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                    (1 - get_base1(prob_obs, 1, "prob_obs", 1)), 
                    "assigning variable prob_obs");
        current_statement_begin__ = 19;
        return stan::math::promote_scalar<fun_return_scalar_t__>(categorical_log(y, prob_obs));
        }
...
class model_GTUMdicho_pair
  : public stan::model::model_base_crtp<model_GTUMdicho_pair> {
private:
        int Categ;
        int Items;
        int Subjt;
        ...
        double vt;
public:
    model_GTUMdicho_pair(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_GTUMdicho_pair_namespace::model_GTUMdicho_pair";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_GTUMdicho_pair_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_GTUMdicho_pair_namespace::model_GTUMdicho_pair stan_model;
#ifndef USING_R
