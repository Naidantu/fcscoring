...
#include "stanExports_GTUMpoly_triplet.h"

RCPP_MODULE(stan_fit4GTUMpoly_triplet_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_GTUMpoly_triplet")
