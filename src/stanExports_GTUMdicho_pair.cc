...
#include "stanExports_GTUMdicho_pair.h"

RCPP_MODULE(stan_fit4GTUMdicho_pair_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_GTUMdicho_pair")
